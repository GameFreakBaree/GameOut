...
import asyncio
from settings import prefix, currency, default_color, footer
            ...
            if command is None:
                ...
                embed = discord.Embed(
                    ...
                    description=f"**Algemeen**\n"
                                ...
                                f"\n\n**Economie**\n"
                                f"`bedel`, `work`, `slut`, `crime`, `fish`, `inventory`, `team`, `pay`, `withdraw`, `deposit`, `rob`, `prestige`, `job`"
                                f"\n\n**Casino Games**\n"
